...
namespace CoreWebAPI.Tests.TestCases
{
    public class StoryManagementControllerTest
    {
        ...
        public async Task LoadStories()
        {
            ...
            _mockService.Setup(s => s.BestStoriesAsync()).ReturnsAsync(response);
